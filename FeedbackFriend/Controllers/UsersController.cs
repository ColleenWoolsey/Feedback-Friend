...
namespace FeedbackFriend.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName")] ApplicationUser applicationUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName")] ApplicationUser applicationUser)
        {
